...
class RatingCreateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["rating_value"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RatingCreateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of RatingCreateRequest from a dict"""
        if obj is None:
            return None
